...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef AryxEchoAPAmmo => new AmmoDef
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        Name = "MaterialHit_Metal_GatlingGun", //MaterialHit_Metal_GatlingGun    //WaterBulletHit                   
                        ApplyToShield = false,
                        //shrinkbydistance = false, obselete
        ...
        private AmmoDef AryxEchoHEAmmo => new AmmoDef
        {
            AmmoMagazine = "AWE85mmAmmoMagazine",
        ...
        private AmmoDef AryxEchoHEFrags => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "HE Echo Frags",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
