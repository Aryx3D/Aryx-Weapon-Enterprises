...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AryxTsunamiTurret => new WeaponDefinition
        {
            ...
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXTsunamiCannon",
                        SpinPartId = "None",
                        MuzzlePartId = "MissileTurretBarrels",
                        AzimuthPartId = "MissileTurretBase1",
                        ElevationPartId = "MissileTurretBarrels",
                        DurabilityMod = 0.15f, //Casemate damage res bonus
                    },
                },
                Muzzles = new[] {
                    "muzzle_projectile_1",
