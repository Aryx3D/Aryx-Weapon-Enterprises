...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition AryxFixedAutocannon => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYX_Fixed_Chord_auto",
                        SpinPartId = "None",
                        MuzzlePartId = "None",
                        AzimuthPartId = "None",
            ...
            {
                PartName = "AC-54 Chord", // name of weapon in terminal
                DeviateShotAngle = 0,
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "ArcWepShipARYXAutocannon_Fire", // WepShipGatlingShot
            ...
            Ammos = new [] {
                AryxAutocannonAmmoWC,
            },
            Animations = AryxFixedChordAnimations,
