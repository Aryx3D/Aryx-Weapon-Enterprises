...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxTacticalModuleEMP => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "EMP Charge", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    ...
                    NonArmor = 100f, // Multiplier for damage against every else.
                },
			...
			AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1f,
                    CustomParticle = "AryxAWEAegisEMP", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "ArcWepShipARYX_TacticalModuleFire", // SubtypeID from your Audio SBC, not a filename
            ...
            Ewar = new EwarDef
            {
                ...
                Strength = (float)(300000000 * AWEGlobalDamageScalar),
                Radius = 250f, // Meters
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        Name = "AryxAWEAegisEMP",
                        ApplyToShield = true,
                        //shrinkbydistance = false, obselete
                        Color = Color(red: 2, green: 25f, blue: 25, alpha: 0),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Restart = false,
            ...
            {
                TravelSound = "ArcWepShipARYX_TacticalModuleFire",
                HitSound = "ArcWepShipARYX_TacticalModuleFire",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
