...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AWEPerditionLancerAmmo => new AmmoDef
        {
            ...
            EnergyMagazineSize = 514, // For energy weapons, how many shots to fire before reloading.
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 21, green: 5, blue: 50, alpha: 0.75f),
                            WidthMultiplier = 1f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: -0.01f, end: 0f),
        ...
        private AmmoDef AWELightningAmmo => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.1f,
                        Color = Color(red: 15, green: 15, blue: 25, alpha: 1),
                        VisualFadeStart = 300, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 420, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentGap = 0f, // Uses Tracer textures and values
                            Speed = 120f, // meters per second
                            Color = Color(red: 15, green: 15, blue: 25, alpha: 0.75f),
        ...
        private AmmoDef AWESuperlaserAmmo => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "AtlasMainAmmo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.75f,
                        Color = Color(red: 100, green: 50, blue: 15, alpha: 0.5f),
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentLength = 240f, // Uses the values below.
                            SegmentGap = 15f, // Uses Tracer textures and values
                            Speed = 120f, // meters per second
                            Color = Color(red: 50, green: 21, blue: 5, alpha: 0.5f),
                            WidthMultiplier = 1f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: -0.01f, end: 0f),
