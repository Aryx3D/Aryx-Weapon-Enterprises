...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxSpartanTurret => new WeaponDefinition
        {
            ...
            {
                PartName = "Spartan Plasma Cannon", // name of weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons)
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "ArcWepShipARYX_SpartanFire", // WepShipGatlingShot
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AryxSpartanPlasmaFlash", // Smoke_LargeGunShot
