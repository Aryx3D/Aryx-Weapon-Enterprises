...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef AryxNovaAmmo => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "AryxNovaAmmo",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.025f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    WidthVariance = Random(start: 0f, end: AWETracerVariation), // adds random value to default width (negatives shrinks width)
                    Tracer = new TracerBaseDef
                    {
                        Enable = true,
                        Length = 16f,
                        Width = 0.025f,
                        Color = Color(red: 16, green: 25, blue: 21, alpha: 1),
        ...
        private AmmoDef AryxNovaEnergyAmmo => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "AryxEnergyNovaAmmo",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.025f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 30,
                        Color = Color(red: 0.5f, green: 12, blue: 25, alpha: 1),
                        Back = false,
                        CustomWidth = 0,
                        UseWidthVariance = false,
                        UseColorFade = true,
