...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AryxLargeIonCannon => new WeaponDefinition
        {
            ...
            {
                PartName = "Centurion Ion Cannon", // name of weapon in terminal
                DeviateShotAngle = 0f,
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayUntilFire = 1, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 100,
                    MaxHeat = 24400, //max heat before weapon enters cooldown (70% of max heat)
                    Cooldown = 0.5f, //percent of max heat to be under to start firing again after overheat accepts .2-.95
                    HeatSinkRate = 900, //amount of heat lost per second
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "ArcWepShipARYXIonCannonFire", // WepShipGatlingShot
                    FiringSoundPerShot = false,
                    ReloadSound = "",
                    NoAmmoSound = "",
                    HardPointRotationSound = "",
                    BarrelRotationSound = "",
                    FireSoundEndDelay = 480, // Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                },
