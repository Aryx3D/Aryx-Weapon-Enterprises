...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        //this fucking thing did not port easily from config to prototype
        private AmmoDef AryxStarfallRocketLaunchStage => new AmmoDef
        {
            AmmoMagazine = "AWEStarfallMissileAmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Starfall Rail-Rocket", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Characters = 10000f, // Character damage multiplier; defaults to 1 if zero or less.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                {
                    Inaccuracy = 1000, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
            ...
            {
                ModelName = "\\Models\\AWE_Starfall\\ARYXRocketArtillery_StarfallMissile.mwm",
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 2f,
                        Color = Color(red: 25, green: 10, blue: 1, alpha: 0),
        ...
        private AmmoDef AryxStarfallRocketFlightStage => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Starfall Rail-Rocket Flight Stage", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 3000, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Starfall Rail-Rocket Deadlock Stage", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
        ...
        private AmmoDef AryxStarfallRocketDeadlockStage => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Starfall Rail-Rocket Deadlock Stage", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1f,
                    CustomParticle = "AryxAWE_StarfallBlast", // Particle SubtypeID, from your Particle SBC
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    Inaccuracy = 20, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    Aggressiveness = 1f, // controls how responsive tracking is.
                    MaxLateralThrust = 0.005f, // controls how sharp the trajectile may turn
                    TrackingDelay = 0, // Measured in Shape diameter units traveled.
                    MaxChaseTime = 0, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
