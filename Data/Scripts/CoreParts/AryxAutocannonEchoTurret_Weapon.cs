...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition AryxEchoAutocannon => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYX_EchoAutocannon",
                        SpinPartId = "None",
            ...
            HardPoint = new HardPointDef 
            {
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "ArcWepShipARYXHeavyAutocannon_Fire", // WepShipGatlingShot
