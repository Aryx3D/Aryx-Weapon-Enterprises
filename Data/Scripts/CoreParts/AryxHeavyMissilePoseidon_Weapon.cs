...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxPoseidonLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXHeavyMissileSalvoLauncher",
            ...
            {
                PartName = "Poseidon Salvo Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
