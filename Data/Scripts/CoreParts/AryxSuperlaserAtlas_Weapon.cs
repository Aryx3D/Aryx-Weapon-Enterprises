...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxPerditionLancer => new WeaponDefinition //MARK V NEW
        {
            ...
            {
                PartName = "Atlas Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
