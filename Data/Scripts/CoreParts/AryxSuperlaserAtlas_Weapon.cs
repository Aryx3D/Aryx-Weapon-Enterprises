...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxPerditionLancer => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AWE_WL_SuperLaser_Large_CB",
            ...
            {
                PartName = "Atlas Superlaser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 15f, // Inventory capacity in kL.
                ...
                {
                    PreFiringSound = "ArcWepShipARYX_SuperLaserWindup", // Audio for warmup effect.
                    FiringSound = "ArcWepShipARYX_SuperLaserFire", // Audio for firing.
            ...
            Ammos = new[] {
                AWESuperlaserAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };
        
        WeaponDefinition AryxMarkVAtlasLaser => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AWE_MarkV_SuperLaser_Large_CB",
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located.
                        AzimuthPartId = "None",
                        ElevationPartId = "None",
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Mark-V Atlas Superlaser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 1f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Off, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 20, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 4000, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 420, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 0, // Heat generated per shot.
                    MaxHeat = 1000, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = .95f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    HeatSinkRate = 0, // Amount of heat lost per second.
                ...
                Audio = new HardPointAudioDef
                {
                    PreFiringSound = "ArcWepShipARYX_MarkV_AtlasWindup", // Audio for warmup effect.
                    FiringSound = "ArcWepShipARYX_MarkV_AtlasFire", // Audio for firing.
                    FiringSoundPerShot = false, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "",
                    NoAmmoSound = "",
                    HardPointRotationSound = "", // Audio played when turret is moving.
            ...
            Ammos = new[] {
                AWEPerditionLancerAmmo,
                AWELightningAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };
