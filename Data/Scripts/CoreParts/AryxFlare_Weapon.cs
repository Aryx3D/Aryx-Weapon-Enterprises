...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition AryxSmallFlareLauncher => new WeaponDefinition
        {
            ...
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYX_SmallFlareLauncher",
                        SpinPartId = "None",
                        MuzzlePartId = "None",
                        AzimuthPartId = "None",
            ...
            {
                PartName = "Flare Launcher", // name of weapon in terminal
                DeviateShotAngle = 0,
