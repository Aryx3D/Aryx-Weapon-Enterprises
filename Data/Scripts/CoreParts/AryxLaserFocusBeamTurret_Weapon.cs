...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AryxFocusBeamTurret => new WeaponDefinition
        {
            ...
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYX_FocusBeam_CompactTurret",
                        SpinPartId = "None",
            ...
            {
                PartName = "Focus Beam Turret", // name of weapon in terminal
