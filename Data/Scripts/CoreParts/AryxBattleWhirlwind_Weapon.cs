...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxJuryTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXJuryCannon",
            ...
            {
                PartName = "Whirlwind Heavy Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXJury_Fire", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AWE_Whirlwind_Muzzleblast", // SubtypeId of muzzle particle effect.
                        Color = Color(red: 25, green: 5, blue: 0.625f, alpha: 1), // Deprecated, set color in particle sbc.
                    ...
                    {
                        Name = "Muzzle_Flash_MediumCalibre",
