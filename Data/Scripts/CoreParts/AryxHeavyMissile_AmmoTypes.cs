...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef AryxStrikerMissileAmmoWC => new AmmoDef
        {
            AmmoMagazine = "AWEStrikerMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Striker Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            Mass = 185, // In kilograms; how much force the impact will apply to the target.
            ...
            {
                AmmoRound = "Striker Missile Stage 2", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    Aggressiveness = 0, // controls how responsive tracking is.
                    MaxLateralThrust = 0f, // controls how sharp the trajectile may turn
                    TrackingDelay = 10f, // Measured in Shape diameter units traveled.
            ...
            {
                ModelName = "\\Models\\AWE_Ammo\\AryxStrikerMissile.mwm",
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 0.005f,
                        Color = Color(red: 25, green: 10, blue: 2, alpha: 1),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 60,
                        Color = Color(red: 25, green: 15, blue: 5, alpha: 1),
                        Back = false,
                        CustomWidth = 0.1f,
        ...
        private AmmoDef AryxStrikerMissileGuidedWC => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Striker Missile Stage 2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            ...
            {
                Shape = LineShape, // LineShape or SphereShape. Do not use SphereShape for fast moving projectiles if you care about precision.
                Diameter = 2.5f, // Diameter is minimum length of LineShape or minimum diameter of SphereShape.
            },
            ObjectsHit = new ObjectsHitDef
            {
                MaxObjectsHit = 0, // Limits the number of entities (grids, players, projectiles) the projectile can penetrate; 0 = unlimited.
			...
			AreaOfDamage = new AreaOfDamageDef
            {
                EndOfLife = new EndOfLifeDef
                {
                    Enable = true,
                    Radius = 5, // Meters
                    Damage = (float)(25000 * AWEGlobalDamageScalar),
                    Depth = 2f,
                    MaxAbsorb = 0f,
                    Falloff = Linear, //.NoFalloff applies the same damage to all blocks in radius
                    //.Linear drops evenly by distance from center out to max radius
                    ...
                    CustomParticle = "AWEStrikerMissileBlast", // Particle SubtypeID, from your Particle SBC
        ...
        private AmmoDef AryxStrikerMissileAntiShield => new AmmoDef
        {
            AmmoMagazine = "AWEStrikerMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Disrupt-Striker Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 185, // In kilograms; how much force the impact will apply to the target.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    Armor = 0.15f, // Multiplier for damage against all armor. This is multiplied with the specific armor type multiplier (light, heavy).
                    Light = -1f, // Multiplier for damage against light armor.
                    Heavy = -1f, // Multiplier for damage against heavy armor.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1.125f,
                    CustomParticle = "AryxStrikerDISROMissileBlast", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "WepSmallWarheadExpl", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond
                },
            },
        ...
        private AmmoDef AryxStrikerMissileEnergyDrain => new AmmoDef
        {
            AmmoMagazine = "AWEStrikerMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Drain-Striker Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 185, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Striker Missile Drain Effect", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    Armor = -1, // Multiplier for damage against all armor. This is multiplied with the specific armor type multiplier (light, heavy).
                    Light = -1f, // Multiplier for damage against light armor.
                    Heavy = -1f, // Multiplier for damage against heavy armor.
                    NonArmor = -1f, // Multiplier for damage against every else.
                },
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1.125f,
                    CustomParticle = "AryxStrikerDRAINMissileBlast", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "WepSmallWarheadExpl", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond
                },
            },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 0.005f,
                        Color = Color(red: 5, green: 25, blue: 5, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxMissileTrail",
        ...
        private AmmoDef AryxStrikerMissileEnergyDrainEffect => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Striker Missile Drain Effect",
        ...
        //Test ammos - to be implemented later.

        private AmmoDef AryxCasabaMissileAmmoWC => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Casaba Howitzer Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 185, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Casaba Howitzer Missile Stage 2", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 0, // Cone in which to randomise direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = 0.5f, // controls how sharp the trajectile may turn
                    TrackingDelay = 0.01f, // Measured in Shape diameter units traveled.
                    MaxChaseTime = 2400, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    OverideTarget = false, // when set to true ammo picks its own target, does not use hardpoint's.
                    MaxTargets = 0, // Number of targets allowed before ending, 0 = unlimited
                    NoTargetExpire = false, // Expire without ever having a target at TargetLossTime
        ...
        private AmmoDef AryxCasabaMissileGuidedWC => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Casaba Howitzer Missile Stage 2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 185, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Casaba Howitzer Missile Stage 3", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    DirectAimCone = 90, //Angle cone in which the drone will open fire.
                },
            },
            Pattern = new PatternDef
            {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 1, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
                VoxelHitModifier = -1, // Voxel damage multiplier; defaults to 1 if zero or less.
                Characters = 5000f, // Character damage multiplier; defaults to 1 if zero or less.
                // For the following modifier values: -1 = disabled (higher performance), 0 = no damage, 0.01f = 1% damage, 2 = 200% damage.
                FallOff = new FallOffDef
                {
                    Distance = 0f, // Distance at which damage begins falling off.
        ...
        private AmmoDef AryxCasabaMissileShotWC => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Casaba Howitzer Missile Stage 3",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 50f,
                        Width = 1f,
                        Color = Color(red: 30, green: 12, blue: 45, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxBallisticTracer",
