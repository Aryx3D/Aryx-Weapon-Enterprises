...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxWhirlwindAmmoWC => new AmmoDef
        {
            AmmoMagazine = "AWE120mmCannonMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            BaseDamage = (AWEHeavyCannonBaseDMG / 1.25f), // Direct damage; one steel plate is worth 100.
			...
			AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    Enable = true,
                    Radius = 3, // Meters
                    Damage = (float)(AWEHeavyCannonBaseDMG * 1.25f) * 3,
                    Depth = 2f,
                    MaxAbsorb = 0f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 25,
                        Color = Color(red: 5, green: 2, blue: 1, alpha: 1),
                        Back = false,
                        CustomWidth = 0.15f,
