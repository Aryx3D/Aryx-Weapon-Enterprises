...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef AryxHeavyFlakAmmoWC => new AmmoDef
        {
            AmmoMagazine = "AWE135mmFlakMagazine",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 128,
                        Color = Color(red: 10, green: 4, blue: 1, alpha: 1),
                        Back = false,
                        CustomWidth = 0,
        ...
        private AmmoDef AryxHeavyFlakShrapWC => new AmmoDef
        {
            ...
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.00000000000f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = (float)(300 * AWEGlobalDamageScalar),
