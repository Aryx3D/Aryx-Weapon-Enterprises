...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxLargeIonCannonBeam => new AmmoDef
        {
            AmmoMagazine = "Energy",
            ...
            {
                Patterns = new[] {
                   "Centurion Ion Beam", "Centurion Ion Beam Muzzleflash", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam",
                   "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam",
                   "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam",
                   "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam",
                   "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam",
                   "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam", "Centurion Ion Beam",
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    Shape = Round, // Round or Diamond - round is more perf intensive but this thing fires slower than your mum so I don't really care.
                },
            },
            Beams = new BeamDef
            {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.05f,
                        Color = Color(red: 3, green: 9, blue: 25f, alpha: 1f),
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 4, green: 9, blue: 25, alpha: 0.75f),
        ...
        private AmmoDef AryxLargeIonCannonBeamFlash => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Centurion Ion Beam Muzzleflash",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.1f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = (float)(100 * AWEGlobalDamageScalar), //6000 per pulse
            Mass = 0, // in kilograms
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = true,
                    ParticleScale = 1,
                    CustomParticle = "AryxAWE_IonCannonWindup", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "soundName", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond - round is more perf intensive but this thing fires slower than your mum so I don't really care.
                },
            },
            Beams = new BeamDef
            {
        ...
        private AmmoDef AryxLargeIonCannonPulse => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Centurion Ion Pulse",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            {
                AmmoRound = "Centurion EMP Fragment", // AmmoRound field of the ammo to spawn.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = true,
                    ParticleScale = 1,
                    CustomParticle = "AryxAWE_IonCannonHit", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "soundName", // SubtypeID from your Audio SBC, not a filename
                    Shape = Round, // Round or Diamond - round is more perf intensive but this thing fires slower than your mum so I don't really care.
                },
            },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1.5f,
                        Width = 2f,
                        Color = Color(red: 10, green: 19, blue: 40, alpha: 1f),
                        VisualFadeStart = 30, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 30, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxPulseLaserEffectL2",
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentGap = 0f, // Uses Tracer textures and values
                            Speed = 60f, // meters per second
                            Color = Color(red: 10, green: 19, blue: 49, alpha: 1f),
                            WidthMultiplier = 1f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: -0.05f, end: 0f),
        ...
        private AmmoDef AryxLargeIonCannonEMP => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Centurion EMP Fragment", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Centurion JumpNull Fragment", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 1, // Cone in which to randomise direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                FallOff = new FallOffDef
                {
                    Distance = 1000, // Distance at which damage begins falling off.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed
                RangeVariance = Random(start: 50, end: 0), // subtracts value from MaxTrajectory
                MaxTrajectoryTime = 0, // How long the weapon must fire before it reaches MaxTrajectory.
                Smarts = new SmartsDef
                {
                    Inaccuracy = 0f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 50f,
                        Width = 2f,
                        Color = Color(red: 10, green: 20, blue: 25, alpha: 0.8f),
                        VisualFadeStart = 30, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 30, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxPulseLaserEffectL2",
        ...
        private AmmoDef AryxLargeIonCannonJumpDisruption => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Centurion JumpNull Fragment", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.25f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
