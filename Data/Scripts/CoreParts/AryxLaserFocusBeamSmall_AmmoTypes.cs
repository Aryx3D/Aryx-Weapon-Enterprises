...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef AryxSmallFocusBeamAmmo => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "AryxSmallFocusBeamAmmo",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.1f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = (float)(50 * AWEGlobalDamageScalar),
            Mass = 0, // in kilograms
            ...
            {
                Patterns = new[] {
                   "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo",
                   "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo",
                   "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo",
                   "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo",
                   "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo",
                   "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo", "AryxSmallFocusBeamAmmo",
                   "AryxSmallFocusPulseAmmo",
                },
                Enable = true,
                TriggerChance = 1f,
                Random = false,
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 2f, // defaults to a value of 1, this setting modifies how much Health is subtracted from a projectile per hit (1 = per hit).
                VoxelHitModifier = 1,
                Characters = 6f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.0005f,
                        Color = Color(red: 25, green: 3f, blue: 3f, alpha: 1f),
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 25, green: 4, blue: 4, alpha: 0.75f),
        ...
        private AmmoDef AryxSmallFocusPulseAmmo => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "AryxSmallFocusPulseAmmo",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                DamageVoxels = false, // true = voxels are vulnerable to this weapon
                SelfDamage = false, // true = allow self damage.
                HealthHitModifier = 2000f, // defaults to a value of 1, this setting modifies how much Health is subtracted from a projectile per hit (1 = per hit).
                VoxelHitModifier = 1,
                Characters = 1200f,
                FallOff = new FallOffDef
                {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1.5f,
                        Width = 1f,
                        Color = Color(red: 40, green: 20, blue: 10f, alpha: 1f),
                        VisualFadeStart = 30, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 30, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxPulseLaserEffectL2",
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentGap = 0f, // Uses Tracer textures and values
                            Speed = 60f, // meters per second
                            Color = Color(red: 40, green: 10, blue: 10f, alpha: 1f),
                            WidthMultiplier = 1f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: -0.05f, end: 0f),
