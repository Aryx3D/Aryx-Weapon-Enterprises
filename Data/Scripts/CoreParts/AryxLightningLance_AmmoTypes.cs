...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxTeslaBeamAmmo => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "AryxTeslaBeamAmmo",
            ...
            {
                AmmoRound = "AryxTeslaBeamAmmo", // AmmoRound field of the ammo to spawn.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.7f,
                        Color = Color(red: 15, green: 20, blue: 40f, alpha: 1f),
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 25, green: 30, blue: 50, alpha: 0.75f),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 64,
                        Color = Color(red: 25, green: 30f, blue: 40, alpha: 1),
                        Back = false,
                        CustomWidth = 1,
