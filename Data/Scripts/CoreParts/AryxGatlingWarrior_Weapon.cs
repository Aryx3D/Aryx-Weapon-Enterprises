...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxWarriorGatling => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXWarriorGatling",
            ...
            {
                PartName = "Warrior Heavy Gatling", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 420, // Set this to 3600 for beam weapons.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXWarriorFire", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Aryx_ATLAS_Muzzleflash", // SubtypeId of muzzle particle effect.
                        Color = Color(red: 25, green: 25, blue: 25, alpha: 1), // Deprecated, set color in particle sbc.
                    ...
                    Effect2 = new ParticleDef
                    {
                        ...
                        Color = Color(red: 1, green: 8, blue: 10, alpha: 1),
            ...
            Ammos = new[] {
                AryxWarriorAmmoAP, // Must list all primary, shrapnel, and pattern ammos.
            },
