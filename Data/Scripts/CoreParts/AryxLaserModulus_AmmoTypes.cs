            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.5f,
                        Color = Color(red: 25, green: 19, blue: 5, alpha: 1f),
                        VisualFadeStart = 30, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 30, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxPulseLaserEffect",
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentGap = 0, // Uses Tracer textures and values
                            Speed = 60f, // meters per second
                            Color = Color(red: 25, green: 19, blue: 5, alpha: 0.75f),
                            WidthMultiplier = 1f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: -0.05f, end: 0f),
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.5f,
                        Color = Color(red: 5, green: 25, blue: 5, alpha: 1f),
                        VisualFadeStart = 30, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 30, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxPulseLaserEffect",
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentGap = 0, // Uses Tracer textures and values
                            Speed = 60f, // meters per second
                            Color = Color(red: 5, green: 25, blue: 5, alpha: 0.75f),
                            WidthMultiplier = 1f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: -0.05f, end: 0f),
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.5f,
                        Color = Color(red: 7, green: 7f, blue: 25, alpha: 1f),
                        VisualFadeStart = 30, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 30, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxPulseLaserEffect",
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentGap = 0, // Uses Tracer textures and values
                            Speed = 60f, // meters per second
                            Color = Color(red: 7, green: 7, blue: 25, alpha: 0.75f),
                            WidthMultiplier = 1f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: -0.05f, end: 0f),
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.5f,
                        Color = Color(red: 19, green: 7f, blue: 25, alpha: 1f),
                        VisualFadeStart = 30, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 30, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxPulseLaserEffect",
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentGap = 0, // Uses Tracer textures and values
                            Speed = 60f, // meters per second
                            Color = Color(red: 19, green: 7, blue: 25, alpha: 0.75f),
                            WidthMultiplier = 1f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: -0.05f, end: 0f),
