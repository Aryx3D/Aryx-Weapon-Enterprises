...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxObliteratorShot => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Phased Antimatter Charge",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 80f,
                        Width = 1f,
                        Color = Color(red: 8, green: 20, blue: 58, alpha: 1),
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5,
                        Width = 0.002f,
                        Color = Color(red: 20, green: 20, blue: 30, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser",
        ...
        private AmmoDef AryxObliteratorArcShrap => new AmmoDef
        {
            AmmoMagazine = "Energy",
