...
namespace Scripts
{
    partial class Parts
    {
        ...
        private AmmoDef AryxKingswordAmmoWC => new AmmoDef
        {
            ...
            {
                AmmoRound = "SAINT 900mm Shrapnel",
                Fragments = 300,
                Degrees = 70,
                Reverse = false,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 80f,
                        Width = 1f,
                        Color = Color(red: 59, green: 40, blue: 8, alpha: 1),
        ...
        private AmmoDef AryxKingswordShrapAmmoWC => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "SAINT 900mm Shrapnel",
