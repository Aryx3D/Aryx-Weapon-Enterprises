...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AryxModulusLaser => new WeaponDefinition
        {
            ...
            {
                PartName = "Modulus Variable Laser", // name of weapon in terminal
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "ArcWepShipARYXModulus_LoopFire", // WepShipGatlingShot
