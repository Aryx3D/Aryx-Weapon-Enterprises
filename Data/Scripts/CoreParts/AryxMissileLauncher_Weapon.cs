...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxLongbowLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXLongbowLauncher",
                    ...
                    new MountPointDef {
                        SubtypeId = "ARYXLongbowLauncher_SG",
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located.
                        AzimuthPartId = "None",
                        ElevationPartId = "None",
                        DurabilityMod = 0.05f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
                },
                Muzzles = new[] {
            ...
            {
                PartName = "Longbow Missile Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 0.025f, // Power draw in MW while not charging, or for non-energy weapons. Defaults to 0.001.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXLongbow_Fire", // Audio for firing.
