...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef AryxCodexAmmoWC => new AmmoDef
        {
            AmmoMagazine = "CODEXAmmoMagazine",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    WidthVariance = Random(start: 0.1f, end: AWETracerVariation), // adds random value to default width (negatives shrinks width)
                    Tracer = new TracerBaseDef
                    {
                        Enable = true,
                        Length = 4.5f,
                        Width = 0.5f,
                        Color = Color(red: 25, green: 18, blue: 3, alpha: 1),
