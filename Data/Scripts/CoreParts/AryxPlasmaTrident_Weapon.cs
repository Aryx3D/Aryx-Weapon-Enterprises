...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxPlasmaBeamCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXPlasmaBeamCannon",
            ...
            {
                PartName = "Trident Beam Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ShotsInBurst = 180, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
                    DelayAfterBurst = 600, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXTridentFire", // Audio for firing.
            ...
            Ammos = new[] {
                AryxTridentBeamAmmoWC, // Must list all primary, shrapnel, and pattern ammos.
            },
