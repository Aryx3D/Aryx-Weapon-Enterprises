...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AryxFocusLance => new WeaponDefinition
        {
            ...
            {
                PartName = "Prometheus Focus Beam", // name of weapon in terminal
                DeviateShotAngle = 0f,
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 100, //10 heat generated per shot
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "ArcWepShipARYXFocusBeamFire", // WepShipGatlingShot
