...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef AryxFlechetteAmmoWC => new AmmoDef
        {
            AmmoMagazine = "84mmFlechetteMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Flechette84mmAmmoDef", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            {
                AmmoRound = "Flechette84mmFullSpeed", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 0,
                DesiredSpeed = 20, // voxel phasing if you go above 5100
                MaxTrajectory = 10000,
        ...
        private AmmoDef AryxFlechetteAmmoFullSpeed => new AmmoDef
        {
            AmmoMagazine = "84mmFlechetteMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Flechette84mmFullSpeed", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
        ...
        private AmmoDef AryxDisruptorAmmoWC => new AmmoDef
        {
            AmmoMagazine = "84mmDisruptorMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Disruptor84mmAmmoDef", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 75f, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Disruptor84mmFullSpeed", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 0, // Cone in which to randomise direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\AWE_Ammo\\AryxDisruptorMissile.mwm",
                VisualProbability = 1f,
                ShieldHitDraw = true,
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "AryxDisruptorRocketTrail", //ShipWelderArc
                        ShrinkByDistance = false,
                        Color = Color(red: 20, green: 0, blue: 25, alpha: 1),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = true,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2f,
                        Width = 0.005f,
                        Color = Color(red: 25, green: 2, blue: 18, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxMissileTrail",
        ...
        private AmmoDef AryxDisruptorAmmoFullSpeed => new AmmoDef
        {
            AmmoMagazine = "84mmDisruptorMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Disruptor84mmFullSpeed", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1, // Direct damage; one steel plate is worth 100.
            Mass = 75f, // In kilograms; how much force the impact will apply to the target.
        ...
        private AmmoDef AryxMissileFrags => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Missile Frags",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 8f,
                        Width = 0.0025f,
                        Color = Color(red: 25, green: 10, blue: 5, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxBallisticTracer",
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 128,
                        Color = Color(red: 2, green: 1, blue: 0, alpha: 1),
                        Back = false,
                        CustomWidth = 0,
                        UseWidthVariance = false,
                        UseColorFade = true,
