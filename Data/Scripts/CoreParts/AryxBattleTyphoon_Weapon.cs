...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition AryxTyphoonTurret => new WeaponDefinition
        {
            ...
            {
                PartName = "Typhoon Heavy Cannon", // name of weapon in terminal
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "ArcWepShipARYXTyphoon_Fire", // WepShipGatlingShot
