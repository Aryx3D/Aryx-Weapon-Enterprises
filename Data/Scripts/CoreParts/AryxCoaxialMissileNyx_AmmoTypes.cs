...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef AryxNyxAmmo_Phasic_Stage1 => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Nyx Phase Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 100, // In kilograms; how much force the impact will apply to the target.
            ...
            DecayPerShot = 10000f, // Damage to the firing weapon itself.
            ...
            {
                AmmoRound = "Nyx Phase Missile Launched",
                Fragments = 1,
                Degrees = 5,
                Reverse = false,
            },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 150, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                AccelPerSec = 100f,
            ...
            {
                ModelName = "\\Models\\AWE_Ammo\\AryxNyxMissile_SingleUse.mwm",
        ...
        private AmmoDef AryxNyxAmmo_Phasic_Stage2 => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Nyx Phase Missile Launched", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 200, // In kilograms; how much force the impact will apply to the target.
            Health = 10, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 0f, // Recoil.
