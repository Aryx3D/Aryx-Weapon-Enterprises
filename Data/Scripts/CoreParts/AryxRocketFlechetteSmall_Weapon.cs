...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxSmallFlechetteLauncher => new WeaponDefinition
        {
            ...
            {
                PartName = "Small Flechette Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.03f, // Inventory capacity in kL.
                ...
                {
                    RateOfFire = 180, // Set this to 3600 for beam weapons.
            ...
            Ammos = new[] {
                ...
                AryxDisruptorAmmoFullSpeed, // Must list all primary, shrapnel, and pattern ammos.
            },
