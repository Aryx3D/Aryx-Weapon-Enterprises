...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef AryxGladiatorAmmo_Standard_Stage1 => new AmmoDef
        {
            AmmoMagazine = "AryxGladiusMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Gladius Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 800, // In kilograms; how much force the impact will apply to the target.
            ...
            {
                AmmoRound = "Gladius Missile Launched",
                Fragments = 1,
                Degrees = 5,
                Reverse = false,
            },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                GravityMultiplier = 0.01f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxChaseTime = 350, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    OverideTarget = false, // when set to true ammo picks its own target, does not use hardpoint's.
                    MaxTargets = 0, // Number of targets allowed before ending, 0 = unlimited
                    NoTargetExpire = false, // Expire without ever having a target at TargetLossTime
                    Roam = false, // Roam current area after target loss
                    KeepAliveAfterTargetLoss = false, // Whether to stop early death of projectile on target loss
                    OffsetRatio = 0.15f, // The ratio to offset the random dir (0 to 1) 
                    OffsetTime = 60, // how often to offset degree, measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..)
                },
            },
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\AWE_Ammo\\AryxGladiusMissile.mwm",
        ...
        private AmmoDef AryxGladiatorAmmo_Standard_Stage2 => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Gladius Missile Launched", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 800, // In kilograms; how much force the impact will apply to the target.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1f,
                    CustomParticle = "AWE_Gladius_Blast", // Particle SubtypeID, from your Particle SBC
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 0.005f,
                        Color = Color(red: 1, green: 8, blue: 25, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxMissileTrail",
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 30,
                        Color = Color(red: 4, green: 8, blue: 25, alpha: 1),
                        Back = false,
                        CustomWidth = 0.1f,
                        UseWidthVariance = false,
                        UseColorFade = true,
         ...
         private AmmoDef AryxGladiatorAmmo_Impulse_Stage1 => new AmmoDef
        {
            AmmoMagazine = "AryxGladiusMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Impulse Gladius Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 4000, // In kilograms; how much force the impact will apply to the target.
            Health = 10, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 0f, // Recoil.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            HardPointUsable = true, // Whether this is a primary ammo type fired directly by the turret. Set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            ...
            Fragment = new FragmentDef
            {
                AmmoRound = "Impulse Gladius Missile Launched",
                Fragments = 1,
                Degrees = 5,
                Reverse = false,
            },
        ...
        private AmmoDef AryxGladiatorAmmo_Impulse_Stage2 => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Impulse Gladius Missile Launched", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 8000, // In kilograms; how much force the impact will apply to the target.
            Health = 10, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 0f, // Recoil.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            HardPointUsable = false, // Whether this is a primary ammo type fired directly by the turret. Set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 0.005f,
                        Color = Color(red: 1, green: 16, blue: 25, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxMissileTrail",
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 30,
                        Color = Color(red: 4, green: 16, blue: 25, alpha: 1),
                        Back = false,
                        CustomWidth = 0.1f,
                        UseWidthVariance = false,
                        UseColorFade = true,
        ...
        private AmmoDef AryxGladiatorAmmo_Phasic_Stage1 => new AmmoDef
        {
            AmmoMagazine = "AryxGladiusMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Gladius Phase Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 820, // In kilograms; how much force the impact will apply to the target.
            Health = 10, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 0f, // Recoil.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            HardPointUsable = true, // Whether this is a primary ammo type fired directly by the turret. Set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            ...
            Fragment = new FragmentDef
            {
                AmmoRound = "Gladius Phase Missile Launched",
                Fragments = 1,
                Degrees = 5,
                Reverse = false,
            },
        ...
        private AmmoDef AryxGladiatorAmmo_Phasic_Stage2 => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Gladius Phase Missile Launched", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            Mass = 800, // In kilograms; how much force the impact will apply to the target.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                EndOfLife = new EndOfLifeDef
                {
                    Enable = true,
                    Radius = 3, // Meters
                    Damage = (float)(8500 * AWEGlobalDamageScalar),
                    Depth = 1.5f,
                    MaxAbsorb = 0f,
                    Falloff = Linear, //.NoFalloff applies the same damage to all blocks in radius
                    //.Linear drops evenly by distance from center out to max radius
