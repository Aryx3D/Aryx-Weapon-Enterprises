...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxRocketArtilleryTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXRocketArtillery",
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "RocketArtilleryBarrels", // The subpart where your muzzle empties are located.
                        AzimuthPartId = "RocketArtilleryAzi",
                        ElevationPartId = "RocketArtilleryElev",
            ...
            {
                PartName = "Rocket Artillery", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 7.5f, // Inventory capacity in kL.
                    IdlePower = 10, // Power draw in MW while not charging, or for non-energy weapons. Defaults to 0.001.
                ...
                Other = new OtherDef
                {
                    ...
                    RestrictionRadius = 25, // Prevents other blocks of this type from being placed within this distance of the centre of the block.
            ...
            Ammos = new[] {
                AryxStarfallRocketLaunchStage, //bleh
                AryxStarfallRocketFlightStage,
                AryxStarfallRocketDeadlockStage,
                AryxKineticFrags,
            },
            Animations = AryxStarfallAnims, //lol this was using the flechette anims and I was wondering why it crashed WC.
        };
