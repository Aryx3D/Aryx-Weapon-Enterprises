...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxFurionRootAmmo => new AmmoDef
        {
            ...
            {
                AmmoRound = "FurionPlasmaFrags", // AmmoRound field of the ammo to spawn.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 0.25f, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 360, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                AccelPerSec = 0f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "Aryx_AWE_Furion_Plasma", //ShipWelderArc
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxFlame1", "AryxFlame2", "AryxFlame3", "AryxFlame4", "AryxFlame5",
                        },
        ...
        private AmmoDef AryxFurionStage1Frag => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "FurionPlasmaFrags", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
