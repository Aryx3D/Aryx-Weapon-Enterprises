...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef AryxInterceptorRocket => new AmmoDef
        {
            AmmoMagazine = "84mmFlechetteMissileMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Interceptor PD Rocket", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 50000, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
