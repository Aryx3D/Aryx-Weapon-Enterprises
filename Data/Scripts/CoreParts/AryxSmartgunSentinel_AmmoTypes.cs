...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxSmartAmmoWC => new AmmoDef
        {
            AmmoMagazine = "50mmSmartMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Smart Projectile Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            BaseDamage = (float)(650 * AWEGlobalDamageScalar), // Direct damage; one steel plate is worth 100.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                FallOff = new FallOffDef
                {
                    ...
                    MinMultipler = 0.45f, // Value from 0.0001f to 1f where 0.1f would be a min damage of 10% of base damage.
                },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        ApplyToShield = true,
                        //shrinkbydistance = false, obselete
                        Color = Color(red: 25, green: 3, blue: 1, alpha: 1),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Restart = false,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 8f,
                        Width = 0.008f,
                        Color = Color(red: 25, green: 2, blue: 1, alpha: 1),
        ...
        private AmmoDef AryxSmartEnergyAmmoWC => new AmmoDef
        {
            AmmoMagazine = "50mmSmartEnergyMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Energy Smart Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = (float)(600 * AWEGlobalDamageScalar), // Direct damage; one steel plate is worth 100.
            Mass = 1, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 0f, // Recoil.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 8f,
                        Width = 0.008f,
                        Color = Color(red: 1, green: 2, blue: 25, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "AryxBallisticTracer",
