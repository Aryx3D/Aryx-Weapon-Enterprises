...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AryxHeavyCoilgun => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXHeavyCoilgun",
                        SpinPartId = "None",
                        MuzzlePartId = "None",
                        AzimuthPartId = "None",
            ...
            {
                PartName = "Predator 850mm Coilgun", // name of weapon in terminal
                DeviateShotAngle = 0f,
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "ArcWepShipARYXHeavyCoilgunWindup",
                    FiringSound = "ArcWepShipARYXHeavyCoilgunFire", // WepShipGatlingShot
                    FiringSoundPerShot = true,
                    ReloadSound = "",
                    NoAmmoSound = "",
                    HardPointRotationSound = "",
                    BarrelRotationSound = "",
                    FireSoundEndDelay = 600, // Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                    FireSoundNoBurst = false,
                },
                Graphics = new HardPointParticleDef {
                    Effect1 = new ParticleDef
                    {
                        Name = "AryxHunterMuzzleBlast",//Muzzle_Flash_Large
            ...
            Ammos = new [] {
                AryxHeavyCoilgunAmmoWC,
                AryxHeavyCoilgunAmmoShrapWC,
            },
